#include "valuecalc_1210.h"
#include "ui_valuecalc_1210.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1210::ValueCalc_1210(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1210)
{
    ui->setupUi(this);
...
ValueCalc_1210::~ValueCalc_1210()
{
    delete ui;
}

void ValueCalc_1210::initWindow()
{
    this->setWindowTitle(QObject::tr("线路保护-后备保护-零序电流2段"));
