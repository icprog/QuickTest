#include "valuecalc_1208.h"
#include "ui_valuecalc_1208.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1208::ValueCalc_1208(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1208)
{
    ui->setupUi(this);
...
ValueCalc_1208::~ValueCalc_1208()
{
    delete ui;
}

void ValueCalc_1208::initWindow()
{
