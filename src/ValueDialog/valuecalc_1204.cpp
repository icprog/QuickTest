#include "valuecalc_1204.h"
#include "ui_valuecalc_1204.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1204::ValueCalc_1204(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1204)
{
    ui->setupUi(this);
...
ValueCalc_1204::~ValueCalc_1204()
{
    delete ui;
}

void ValueCalc_1204::initWindow()
{
    this->setWindowTitle(QObject::tr("线路保护-后备保护-接地距离3段"));
