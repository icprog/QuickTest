#include "valuecalc_1203.h"
#include "ui_valuecalc_1203.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1203::ValueCalc_1203(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1203)
{
    ui->setupUi(this);
...
ValueCalc_1203::~ValueCalc_1203()
{
    delete ui;
}

void ValueCalc_1203::initWindow()
{
    this->setWindowTitle(QObject::tr("线路保护-后备保护-接地距离2段"));
