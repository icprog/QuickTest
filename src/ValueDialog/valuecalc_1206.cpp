#include "valuecalc_1206.h"
#include "ui_valuecalc_1206.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1206::ValueCalc_1206(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1206)
{
    ui->setupUi(this);
...
ValueCalc_1206::~ValueCalc_1206()
{
    delete ui;
}

void ValueCalc_1206::initWindow()
{
    this->setWindowTitle(QObject::tr("线路保护-后备保护-相间距离2段"));
