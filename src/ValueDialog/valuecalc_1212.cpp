#include "valuecalc_1212.h"
#include "ui_valuecalc_1212.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1212::ValueCalc_1212(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1212)
{
    ui->setupUi(this);
...
ValueCalc_1212::~ValueCalc_1212()
{
    delete ui;
}

void ValueCalc_1212::initWindow()
{
    this->setWindowTitle(QObject::tr("线路保护-后备保护-零序电流4段"));
