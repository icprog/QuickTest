#include "valuecalc_1213.h"
#include "ui_valuecalc_1213.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1213::ValueCalc_1213(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1213)
{
    ui->setupUi(this);
...
ValueCalc_1213::~ValueCalc_1213()
{
    delete ui;
}

void ValueCalc_1213::initWindow()
{
    this->setWindowTitle(QObject::tr("线路保护-后备保护-零序过流加速"));
