#include "valuecalc_1207.h"
#include "ui_valuecalc_1207.h"

#include "quicktestcore.h"
extern QuickTestCore core;

ValueCalc_1207::ValueCalc_1207(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ValueCalc_1207)
{
    ui->setupUi(this);
...
ValueCalc_1207::~ValueCalc_1207()
{
    delete ui;
}

void ValueCalc_1207::initWindow()
{
